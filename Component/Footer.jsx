...
function Footer() {
  return (
    <footer className="p-4 font-rubik  sm:p-6 bg-primary text-last ">
      <div className="md:flex text-last  md:justify-between">
        ...
        <div className="grid grid-cols-2 text-last gap-8 sm:gap-6 sm:grid-cols-3">
          
          <div>
            <h2 className="mb-6 text-sm font-semibold text-last uppercase  ">
              Follow us
            </h2>
            <ul className="text-last dark:text-last">
              <li className="mb-4">
                <a
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-last sm:text-center dark:text-last">
          © 2022{" "}
          <a href=" " className="hover:underline">
            Tosiron™
          </a>
...
<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path></svg>
          ...
          {/* <a  className="text-last hover:text-last  ">
